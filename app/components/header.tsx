...
//       src="/logo.png"
//       alt="Logo"
//       className="absolute top-1/2 left-0 transform -translate-y-1/2 scale-150"
//     />
//   </div>
// </Link> */}
...
//                 </button>
//                 {index < 2 && (
//                   <span className={`ml-3 w-[1px] h-3 ${isTransparent ? "bg-white/20" : "bg-slate-200"
//                     }`} />
//                 )}
//               </div>
//             ))}
...
//           {/* Mobile Menu Icon */}
//           <button className={`md:hidden p-2 transition-colors ${isTransparent ? "text-white" : "text-slate-900"
//             }`}>
